...
import bgPoster from "./assets/main1-poster.webp";
...
const REVEAL_CONTENT = [
  {
    upper: ["name: Priyansh", "age: 19"],
    lower: "major: computer science",
  },
  {
    upper: [
      "I debug code for 3 hours only to find a missing semicolon.",
      "I have 47 browser tabs open and I'm afraid to close any of them.",
      "My git commit messages went from 'fix bug' to 'pls work' to 'I hate everything'.",
    ],
    lower: "relatable dev life facts 😭",
  },
  {
    upper: [
      "I told my mom I was a full-stack developer. She asked which restaurant.",
      "A sleep study found programmers dream in dark mode.",
      "My code works and I have no idea why — that's called job security.",
    ],
    lower: "100% true, trust me bro",
  },
];
